...
?train
?trainControl
training_control <- trainControl(method ='repeatedcv', repeats = 10 )
knn_model <- train(form = as.matrix(XTrain[31]) ~ ., data = as.matrix(XTrain[2:30]), trControl = training_control, method = 'knn')
